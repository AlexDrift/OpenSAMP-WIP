...
char* RPC_VehicleDestroyed = "\x61";
char* RPC_WeaponPickup = "\x85";
...
char* RPC_Spawn = "\x0B";
char* RPC_Death = "\x0C";
char* RPC_NPCJoin = "\x0D";
char* RPC_SendDeathMessage = "\x0E";
char* RPC_SetPlayerMapIcon = "\x0F";
char* RPC_RemoveComponent = "\x10";
char* RPC_HideText3DLabel = "\x11";
char* RPC_SetPlayerChatBubble = "\x12";

char* RPC_ShowPlayerDialog = "\x14";
char* RPC_PlayerDialogResponse = "\x15";
char* RPC_PlayerClickPlayer = "\x16";
char* RPC_SetVehicleParamsEx = "\x17";
char* RPC_ClientJoin = "\x18";
char* RPC_EnterVehicle = "\x19";
char* RPC_ExitVehicle = "\x1A";
char* RPC_UpdateScoreboard = "\x1B";
char* RPC_SetPlayerInterior = "\x1C";
char* RPC_SetPlayerCameraPos = "\x1D";
char* RPC_SetPlayerCameralookAt = "\x1E";
char* RPC_SetVehiclePos = "\x1F";
char* RPC_SetVehicleZAngle = "\x20";
char* RPC_SetVehicleParamsForPlayer = "\x21";
char* RPC_SetPlayerCameraBehindPlayer = "\x22";
char* RPC_HidePlayerForPlayer = "\x23"; //RPC_WorldPlayerRemove
char* RPC_ShowVehicleToPlayer = "\x24"; //RPC_WorldVehicleAdd
char* RPC_HideVehicleToPlayer = "\x25"; //RPC_WorldVehicleRemove
char* RPC_PlayerDeath = "\x26"; //RPC_WorldPlayerDeath
char* RPC_DamageVehicle = "\x27";
char* RPC_ShowCheckpoint = "\x28";
char* RPC_AddGangZone = "\x29";

char* RPC_PlayCrimeReportForPlayer = "\x2D";

char* RPC_ChangeWeather = "\x31";
char* RPC_SetPlayerSkin = "\x32";
char* RPC_SetPlayerName = "\x33";
char* RPC_SetPlayerPosition = "\x34";
char* RPC_SetPlayerPositionFindZ = "\x35";
char* RPC_SetPlayerHealth = "\x36";
char* RPC_TogglePlayerControllable = "\x37";
char* RPC_PlayerPlaySound = "\x38";
char* RPC_SetWorldBounds = "\x39";
char* RPC_GivePlayerMoney = "\x3A";
char* RPC_SetPlayerFacingAngle = "\x3B";
char* RPC_ResetPlayerMoney = "\x3C";
char* RPC_ResetPlayerWeapons = "\x3D";
char* RPC_GivePlayerWeapon = "\x3E";

char* RPC_LinkVehicleToInterior = "\x40";
char* RPC_SetPlayerArmour = "\x41";

char* RPC_SetPlayerArmedWeapon = "\x42";
char* RPC_SetCustomSpawn = "\x43";
char* RPC_SetPlayerTeam = "\x44";
char* RPC_PutPlayerInVehicle = "\x45";
char* RPC_RemovePlayerFromVehicle = "\x46";
char* RPC_SetPlayerColor = "\x47";
char* RPC_ShowGameTextForPlayer = "\x48";
char* RPC_ForceClassSelection = "\x49";
char* RPC_AttachObjectToPlayer = "\x4A";
char* RPC_Menu_InitForPlayer = "\x4B";
char* RPC_Menu_ShowForPlayer = "\x4C";
char* RPC_Menu_HideForPlayer = "\x4D";
char* RPC_CreateExplosion = "\x4E";

char* RPC_ShowPlayerNameTagForPlayer = "\x4F";

char* RPC_ClickTextDraw = "\x52";

char* RPC_OnPlayerTakeDamage = "\x54";
char* RPC_EditAttachedObject = "\x55"; //TODO
char* RPC_EditObject = "\x56"; //TODO
char* RPC_SelectObject = "\x57"; //TODO

char* RPC_SetPlayerTime = "\x59";
char* RPC_TogglePlayerClock = "\x5A";
char* RPC_ScriptCash = "\x5B";
char* RPC_SpawnPlayerForPlayer = "\x5C"; //RPC_WorldPlayerAdd
char* RPC_SetPlayerShopName = "\x5D";
char* RPC_SetSkillLevel = "\x5E";
char* RPC_SetPlayerDrunkLevel = "\x5F";
char* RPC_ShowText3DLabels = "\x60";
char* RPC_HideCheckpoint = "\x61";
char* RPC_ShowRaceCheckpoint = "\x62";
char* RPC_HideRaceCheckpoint = "\x63";
char* RPC_GameModeRestart = "\x64";
char* RPC_Chat = "\x66";
char* RPC_ServerStats = "\x67";

char* RPC_EnableStuntBonus = "\x69";
char* RPC_TextDraw_SetString = "\x6A";
char* RPC_PlayAudioStream = "\x6B";
char* RPC_StopAudioStream = "\x6C";
char* RPC_RemoveBuilding = "\x6D";

char* RPC_SpawnObject = "\x6E";
char* RPC_SetObjectPosition = "\x6F";
char* RPC_SetObjectRotation = "\x70";
char* RPC_DestroyObject = "\x71";

char* RPC_ServerCommand = "\x74";
char* RPC_SetInteriorID = "\x75";
char* RPC_OnPlayerClickMap = "\x76"; //"\x68"?
char* RPC_RemoveGangZone = "\x77";
char* RPC_FlashGangZone = "\x78";
char* RPC_StopFlashGangZone = "\x79";
char* RPC_ApplyAnimation = "\x7A";
char* RPC_ClearAnimation = "\x7B";
char* RPC_SetPlayerSpecialAction = "\x7C";
char* RPC_SetPlayerFightingStyle = "\x7D";
char* RPC_SetPlayerVelocity = "\x7E";
char* RPC_SetVehicleVelocity = "\x7F";

char* RPC_MoveObject = "\x83";
char* RPC_StopObject = "\x84";

char* RPC_TogglePlayerSpectating = "\x86";

char* RPC_SetPlayerSpectatingPlayer = "\x88";
char* RPC_SetPlayerSpectatingVehicle = "\x89";

char* RPC_RequestClass = "\x8A";
char* RPC_RequestSpawn = "\x8B";
char* RPC_ConnectionRejected = "\x8C";
char* RPC_ClientMessage = "\x8D";
char* RPC_WorldTime = "\x8E";

char* RPC_ScmEvent = "\x90";
char* RPC_WeaponPickup = "\x91"; //Maybe not
char* RPC_PickUpPickup = "\x92";
char* RPC_MenuSelect = "\x93";
char* RPC_SetPlayerWantedLevel = "\x94";
char* RPC_ShowTextDraw = "\x95";
char* RPC_HideTextDraw = "\x96";
char* RPC_VehicleDestroyed = "\x97";
char* RPC_NewPlayer = "\x98"; //RPC_ServerJoin
char* RPC_PlayerLeave = "\x99"; //RPC_ServerQuit
char* RPC_InitGame = "\x9A";
char* RPC_MenuQuit = "\x9B";

char* RPC_RemovePlayerMapIcon = "\x9F";
char* RPC_SetPlayerAmmo = "\xA0";
char* RPC_SetGravity = "\xA1";
char* RPC_SetVehicleHealth = "\xA2";
char* RPC_AttachTrailerToVehicle = "\xA3";
char* RPC_DetachTrailerFromVehicle = "\xA4";

//0.3d
char* RPC_ToggleWidescreen = "\xFF"; //"\x59"; // useless
char* RPC_AttachAttachedObject = "\xFF"; //"\x8A";
char* RPC_ShowPickupForPlayer = "\xFF"; //"\x19";
char* RPC_HidePickupForPlayer = "\xFF"; //"\x1A";
char* RPC_SendTime = "\xFF"; //"\x3E";
char* RPC_SetTimeEx = "\xFF"; //"\x79";
...
char* RPC_HidePlayerForPlayer = "\xFF"; //RPC_WorldPlayerRemove
char* RPC_ShowVehicleToPlayer = "\xFF"; //RPC_WorldVehicleAdd
char* RPC_HideVehicleToPlayer = "\xFF"; //RPC_WorldVehicleRemove
char* RPC_PlayerDeath = "\xFF"; //RPC_WorldPlayerDeath
...
char* RPC_NewPlayer = "\xFF"; //RPC_ServerJoin
char* RPC_PlayerLeave = "\xFF"; //RPC_ServerQuit
char* RPC_InitGame = "\xFF";

...
cell AMX_NATIVE_CALL funcSendPlayerMessageToPlayer ( AMX* a_AmxInterface, cell* a_Params )
{
	...
	__NetGame->PlayerRPC(RPC_Chat, &bStream, playerID, 3);
	return 0;
}
...
//	{ "AttachPlayerObjectToPlayer",					NULL },					// 266 LOLOLOL
	...
	//{ "EnableVehicleFriendlyFire", funcEnableVehicleFriendlyFire },
	{ "TextDrawSetSelectable", funcTextDrawSetSelectable },
	{ "TextDrawSetPreviewModel", funcTextDrawSetPreviewModel },
	{ "TextDrawSetPreviewRot", funcTextDrawSetPreviewRot },
	{ "TextDrawSetPreviewVehCol", funcTextDrawSetPreviewVehCol },
